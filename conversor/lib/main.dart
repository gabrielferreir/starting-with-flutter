...
const request = 'https://api.hgbrasil.com/finance?format=json&key=4fe567c6';
              ...
              switch (snapshot.connectionState) {
                ...
                case ConnectionState.waiting:
                  return Center(
                    child: Text(
                      'Carregando Dados...',
                      style: TextStyle(color: Colors.amber, fontSize: 16.00),
                    ),
                  );
                default:
                    ...
                    return SingleChildScrollView(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Divider(),
                          buildTextField('Reais', 'BLR\$', realController,
                              this._realChanged),
                          Divider(),
